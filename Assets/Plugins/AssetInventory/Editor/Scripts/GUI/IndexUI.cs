...
#pragma warning restore CS4014
        ...
        private static void GUILabelWithText(string label, string text, int width = 95, string tooltip = null, bool wrappable = false, bool selectable = false)
        {
            GUILayout.BeginHorizontal();
        ...
        private static void BeginIndentBlock(int widthOverride = 0)
        {
            GUILayout.BeginHorizontal();
        ...
        private static void EndIndentBlock(bool autoSpace = true)
        {
        ...
        private static bool UIShown(string key)
        {
        ...
        private static void UILine(string key, Action content, bool alwaysShow = false)
        {
            UIBlock(key, content, alwaysShow, true);
        }

        private static void UIBlock2(string key, Action content, bool alwaysShow = false)
        {
            UIBlock(key, content, alwaysShow, false, false);
        }

        private static void UIBlock(string key, Action content, bool alwaysShow = false, bool horizontal = false, bool expand = true)
        {
            AssetInventorySettings c = AssetInventory.Config;
            bool isAdvanced = c.advancedUI.Contains(key);
