...
namespace AssetInventory
{
    public sealed class TagSelectionUI : PopupWindowContent
    {
        ...
        public override void OnGUI(Rect rect)
        {
            ...
            {
                _assetInfo.ForEach(info => AssetInventory.AddTagAssignment(info, _newTag, _target, true));
                _newTag = "";
            }
            ...
            if (_tags != null)
            {
                ...
                else
                {
                    ...
                    foreach (Tag tag in _tags)
                    {
                        ...
                        {
                            _assetInfo.ForEach(info => AssetInventory.AddTagAssignment(info, tag.Name, _target, true));
                            _onChange?.Invoke();
