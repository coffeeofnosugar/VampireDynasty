	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float fbcolsoffset6 = 1.0f / _Col;
				float fbrowsoffset6 = 1.0f / _Row;
				// Speed of animation
				float fbspeed6 = _Time[ 1 ] * _Speed;
				// UV Tiling (col and row offset)
				float2 fbtiling6 = float2(fbcolsoffset6, fbrowsoffset6);
				// UV Offset - calculate current tile linear index, and convert it to (X * coloffset, Y * rowoffset)
				// Calculate current tile linear index
				float fbcurrenttileindex6 = floor( fmod( fbspeed6 + 0.0, fbtotaltiles6) );
				fbcurrenttileindex6 += ( fbcurrenttileindex6 < 0) ? fbtotaltiles6 : 0;
				// Obtain Offset X coordinate from current tile linear index
				float fblinearindextox6 = round ( fmod ( fbcurrenttileindex6, _Col ) );
				// Multiply Offset X by coloffset
				float fboffsetx6 = fblinearindextox6 * fbcolsoffset6;
				// Obtain Offset Y coordinate from current tile linear index
				float fblinearindextoy6 = round( fmod( ( fbcurrenttileindex6 - fblinearindextox6 ) / _Col, _Row ) );
				// Reverse Y to get tiles from Top to Bottom
				fblinearindextoy6 = (int)(_Row-1) - fblinearindextoy6;
				...
				float4 Color = tex2D( _TextureSample0, fbuv6 );
...
/*ASEBEGIN
Version=19603
Node;AmplifyShaderEditor.RangedFloatNode;7;-1296,-112;Inherit;False;Property;_Col;Col;0;0;Create;True;0;0;0;False;0;False;6;6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;5;-528,-96;Inherit;True;Property;_TextureSample0;Texture Sample 0;1;0;Create;True;0;0;0;False;0;False;-1;None;57ef3161f1ccd7c47b367de162a694b5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2DARRAY;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=961D311B29D013366A54C2A2E2EC1BBF7310A831